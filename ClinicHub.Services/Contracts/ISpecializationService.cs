...
namespace ClinicHub.Services.Contracts
{
    ...
    {
        Task<List<SpecializationDto>> GetActiveAsync(bool? isFamous = null);
        Task<PagginatedResult<SpecializationDto>> GetAllAsync(int pageNumber = 1, int pageSize = 20, bool? isFamous = null, bool? isActive = null);
